...
class Solution {
    public List<List<Integer>> groupThePeople(int[] groupSizes) {
        ...
        for(int index = 0; index < groupSizes.length; ++index) {
            ...
            if(groups[groupSizes[index]] == null) {
                 groups[groupSizes[index]] = new ArrayList();
                 groups[groupSizes[index]].add(index);
            ...
            if(groups[groupSizes[index]].size() == groupSizes[index]) {
                
                result.add(groups[groupSizes[index]]);
                groups[groupSizes[index]] = new ArrayList();
