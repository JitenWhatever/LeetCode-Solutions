...
class Solution {
    public int compareVersion(String version1, String version2) {
        ...
        while (index_1 < N || index_2 < M) {
            while(index_1 < N && version1.charAt(index_1) != '.') {
                version_1 = version_1 * 10 + (version1.charAt(index_1++) - '0');
            }
            
             while(index_2 < M && version2.charAt(index_2) != '.') {
                version_2 = version_2 * 10 + (version2.charAt(index_2++) - '0');
            }
